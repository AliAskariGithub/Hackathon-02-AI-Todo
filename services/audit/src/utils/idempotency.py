"""
Idempotency Check Utility for Audit Service

Uses Dapr State Store to track processed events and prevent duplicate audit log entries.
"""
...
class IdempotencyChecker:
    ...
    Tracks processed correlation IDs to prevent duplicate audit log entries.
    """
