"""
Idempotency Check Utility for Notification Service

Uses Dapr State Store to track processed events and prevent duplicate processing.
"""
...
class IdempotencyChecker:
    ...
    Tracks processed correlation IDs to prevent duplicate event processing.
    """
