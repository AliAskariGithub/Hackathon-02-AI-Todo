  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.access_token) {
        ...
        if (tokenSaved && tokenSaved === response.access_token && userIdSaved) {
          setRedirecting(true);
          ...
          const errorMsg = "Login successful but authentication state could not be established. Please try again.";
          setError(errorMsg);
          toast({
            variant: "destructive",
